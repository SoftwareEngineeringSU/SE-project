...
<html>
<head>
<title>My Albums a Entertainment Category  Flat Bootstarp Resposive Website Template | Albums :: w3layouts</title>
					...
					<div class="top-menu">
						<nav class="navigation">
							<ul class="cl-effect-16">
								...
								<li><a class="active" href="albums.html">Recent Albums</a></li>
		...
		<div class="content-grids">
			...
			<h3 class="tittle">Albums</h3>
					<div class="content-grid">
						...
						<ul>
							<li><a href="#"><i class="glyphicon glyphicon-thumbs-up"></i></li>
							<li><a href="#"><i class="glyphicon glyphicon-eye-open"></i></a></li>
							<li><a href="#"><i class="glyphicon glyphicon-paperclip"></i></li>
							
						</ul>
						<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
					</div>
					<div id="small-dialog" class="mfp-hide">
						<iframe src="https://www.youtube.com/embed/tlYcUqEPN58" frameborder="0" allowfullscreen></iframe>
