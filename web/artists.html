...
<html>
<head>
<title>My Albums a Entertainment Category  Flat Bootstarp Resposive Website Template | Artists :: w3layouts</title>
	...
	<!--start-header-->
	  <div class="header" id="home">
		  <div class="header-top">
			...
			<div class="top-nav">
				  <div class="container">
				    <div class="home"><a href="index.html"><i class="glyphicon glyphicon-home"> </i></a></div>
					...
					<div class="top-menu">
						<nav class="navigation">
							<ul class="cl-effect-16">
								...
								<li><a href="albums.html">Recent Albums</a></li>
	...
	<div class="artist-section">
	  <div class="container">
	   <h3 class="tittle">Artists</h3>
		<div class="cartire-grid simpleCart_shelfItem">
			<div class="col-md-4 cartire-grid-img">
				<img src="images/s1.jpg" title="tries" />
			</div>
			<div class="col-md-5 cartire-grid-info">
				<ul>
					<li><span>New</span> |&nbsp;&nbsp;Available !</li>
				</ul>
				   <a href ="single.html"><h3>Fondmetal 7500</h3></a>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
			</div>
			<div class="col-md-3 cartire-grid-cartinfo">
				<h4>REDUCED PRICE!</h4>
					<span>$502.00</span>
						<ul>
						...
						<div class="item_add"><span class="item_price"><a class="add two" href="#">Add to cart</a></span></div>
						<a class="view" href="single.html">View</a>
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="cartire-grid simpleCart_shelfItem">
			<div class="col-md-4 cartire-grid-img">
				<img src="images/s2.jpg" title="tries" />
			</div>
			<div class="col-md-5 cartire-grid-info">
				<ul>
					<li><span>New</span> |&nbsp;&nbsp;Available !</li>
			...
			<div class="cartire-grid simpleCart_shelfItem">
			<div class="col-md-4 cartire-grid-img">
				<img src="images/s4.jpg" title="tries" />
			</div>
			<div class="col-md-5 cartire-grid-info">
				<ul>
					<li><span>New</span> |&nbsp;&nbsp;Available !</li>
